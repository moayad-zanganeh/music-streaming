...
const musicItems = [
  {
    src: 'artist-page/singles/Frame 69 (1).png',
    alt: 'Adele',
    title1: 'Cold Shoulder',
  },
  {
    src: 'artist-page/singles/Frame 69 (2).png',
    alt: 'Adele',
    title1: 'Hometown Glory',
  },
  {
    src: 'artist-page/singles/Frame 69.png',
    alt: 'Adele',
    title1: 'Make You Feel My Love',
  },
  {
    src: 'artist-page/singles/Frame 69 (3).png',
    alt: 'Adele',
    title1: 'Set Fire to the Rain',
  },
  {
    src: 'artist-page/singles/Frame 69 (4).png',
    alt: 'Adele',
