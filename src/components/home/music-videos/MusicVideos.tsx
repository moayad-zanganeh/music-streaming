...
const musicItems = [
  { src: "Music Videos/Frame 71.png", alt: "Adele", title1: "Water Under The Bridge", title2: "Adele" },
  { src: "Music Videos/Frame 369.png", alt: "Billie Eilish", title1: "Ocean Eyes", title2: "Billie Eilish" },
  { src: "Music Videos/Frame 370.png", alt: "Taylor Swift", title1: "Bejeweled", title2: "Taylor Swift" },
];
...
export default function MusicVideos() {
  ...
  return (
    <Box
      sx={{
        width: { xs: "40%", sm: "81%", md: "87%", lg: "87%" },
        px: { xs: 1, sm: 2, md: 3, lg: 4 },
        m: "5% auto",
        position: "relative",
        flexDirection: "column",
        alignItems: "center",
        left: { xs: "-18%", sm: "0", md: "16px", lg: "16px" },
      }}
    >
